                ...
                <div className="auth-card-box">
                    <div className="auth-card-top">
                        ...
                        {page === 1 && (
                            ...
                            <InputBox ref={passwordRef} label='비밀번호*' type={passwordType} placeholder='비밀번호를 입려해주세요.' value={password} onChange={onPasswordChangeHandler} error={isPasswordError} message={passwordErrorMessage} icon={passwordButtonIcon} onButtonClick={onPasswordButtonClickHandler} onKeyDown={onPasswordKeyDownHandler}/>
                ...
                <div className="auth-jumbotron-box">
                    <div className="auth-jumbotron-contents">
                        ...
                        <div className="auth-jumbotron-text-box">
                            ...
                            <div className="auth-jumbotron-text">{'MoCoCo Board 입니다.'}</div>
                        </div>
                    </div>
                </div>
            </div>
