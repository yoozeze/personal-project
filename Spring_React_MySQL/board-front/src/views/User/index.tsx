...
export default function User() {
            ...
            <div id="user-top-wrapper">
                <div className="user-top-container">
                    ...
                    <div className="user-top-info-box">
                        ...
                        <div className="user-top-info-email">{'zeze@naver.com'}</div>
                    </div>
                </div>
            </div>
        );
    ...
    const UserBottom = () => {
        ...
        useEffect(() => {
            if (!userEmail) return;
            getUserBoardListRequest(userEmail).then(getUserResponse);
        }, [userEmail]);
                        ...
                        <div className="user-bottom-side-box">
                            <div className="user-bottom-side-card" onClick={onSideCardClickHandler}>
                                <div className="user-bottom-side-container">
                                    ...
                                    <>
                                    <div className="user-bottom-side-text">{'내 게시물로가기'}</div>
                                    <div className="icon-box">
