            ...
            <div className="footer-container">
                <div className="footer-top">
                    <div className="footer-logo-box">
                        ...
                        <div className="footer-logo-text">{'MoCoCo Board'}</div>
                    </div>
                    <div className="footer-link-box">
                        <div className="footer-email-link">{'fbghrud3@naver.com'}</div>
                ...
                <div className="footer-bottom">
                    <div className="footer-copyright">{'Copyright ⓒ 2024 zeze. All Rights Reserved.'}</div>
                </div>
            </div>
        </div>
    )
